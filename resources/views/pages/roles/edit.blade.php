    ...
    <div class="p-6">
            ...
            <div class="ps-3">
                <nav class="flex" aria-label="breadcrumb">
                    <ol class="inline-flex items-center space-x-2">
                        ...
                        <li class="text-gray-700 font-medium">Edit Role</li>
                    </ol>
                </nav>
            </div>
            @can('role-list')
        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-xl shadow-sm p-6">
                <h5 class="text-xl font-semibold mb-6 text-gray-800">Edit Role</h5>
                            ...
                            @foreach ($permissoes as $permission)
                                <label class="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded">
                                    <input type="checkbox" 
                                           ...
                                           value="{{ $permission->id }}"
                                           @checked(in_array($permission->id, $rolePermissoes) || old("permission.{$permission->id}"))
